...
public interface ITransactionFinanceService
{
  ...
  public Task<Result<List<TransactionDataDto>>> GetTransactionItemsByAsyncForDate(DateTime StartDate, DateTime EndDate, DateType dateType, int userId, TransactionType transactionType, CancellationToken cancellationToken = default);
